...
export const ChannelBreakdown = ({ role, channels, selectedChannel, onSelectChannel }: ChannelBreakdownProps) => {
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-lg font-semibold text-foreground">
              {t(isAdmin ? "reports.roleContent.admin.channels.title" : "reports.roleContent.client.channels.title")}
            </h2>
            <p className="text-xs text-muted-foreground">
              {t(isAdmin ? "reports.roleContent.admin.channels.description" : "reports.roleContent.client.channels.description")}
            </p>
          </div>
        </div>
      </div>
