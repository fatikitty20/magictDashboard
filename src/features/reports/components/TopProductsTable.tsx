...
export const TopProductsTable = ({ products }: TopProductsTableProps) => {
  ...
  <section className={claseTarjeta("base", "overflow-hidden")}>
    <div className="border-b border-border px-5 py-4">
      <h2 className="text-lg font-semibold text-foreground">{t("reports.topProducts.title")}</h2>
      <p className="text-xs text-muted-foreground">{t("reports.topProducts.description")}</p>
    </div>
